...
results_meta = collections.OrderedDict((
    ...
    ('Requirement Prices and Quantities',
        ...
        'presets': collections.OrderedDict((
            ...
            ('REC Price Lines ($/MWh)',{'x':'year', 'y':'$', 'series':'scenario', 'explode': 'type', 'chart_type':'Line', 'adv_op':'Ratio', 'adv_col':'type', 'adv_col_base':'q_nat_gen', 'filter': {'type':['nat_gen','q_nat_gen']}}),
            ('CO2 Price Lines ($/MWh)',{'x':'year', 'y':'$', 'series':'scenario', 'explode': 'type', 'chart_type':'Line', 'adv_op':'Ratio', 'adv_col':'type', 'adv_col_base':'q_annual_cap', 'filter': {'type':['annual_cap','q_annual_cap'],'subtype':['co2']}}),
