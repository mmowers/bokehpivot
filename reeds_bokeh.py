...
def build_reeds_report(html_num='one'):
    ...
    if html_num == 'one':
        ...
        auto_open = '"no"'
    sp.call('start cmd /K python ' + this_dir_path + '/reports/interface_report.py ' + scenarios_string + ' ' + base + ' ' + report_name +' ' + report_path + ' "' + html_num + '" ' + output_dir + ' ' + auto_open, shell=True, cwd=this_dir_path+r'/reports')
