...
results_meta = collections.OrderedDict((
    ...
    ('Tech Val Streams potential',
        ...
        'presets': collections.OrderedDict((
            ...
            ('$/MWh by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','type':costs+values_decomp+['MWh/kW'],'new_old':['new']}}),
            ...
            ('Stacked profitability final p60 decomposed', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','type':costs+values_decomp+['total cost'],'new_old':['new']}}),
