...
results_meta = collections.OrderedDict((
    ...
    ('Tech Val Streams chosen',
        ...
        'presets': collections.OrderedDict((
            ...
            ('$/kW by type final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'kW', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['kW'], 'year':'last', }}),
            ...
            ('Resmarg $/kW decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'kW', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg_cap+['kW'], 'year':'last', }}),
            ...
            ('$/MWh by type final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['MWh'], 'year':'last', }}),
            ('$/MWh by type decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values_decomp+['MWh'], 'year':'last', }}),
            ...
            ('LCOE final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'y_scale':'-1', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+['MWh'], 'year':'last', }}),
            ...
            ('Load $/MWh decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_load+['MWh'], 'year':'last', }}),
            ...
            ('Resmarg $/MWh decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg+['MWh'], 'year':'last', }}),
            ...
            ('Profitability final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['total cost'], 'year':'last', }}),
            ('Profitability decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values_decomp+['total cost'], 'year':'last', }}),
            ...
            ('Load profit decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_load+['total cost'], 'year':'last', }}),
            ...
            ('Resmarg profit decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9s', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg+['total cost'], 'year':'last', }}),
            ...
            ('OLD System LCOE over time', {'chart_type':'Bar', 'x':'year','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'filter': {'cost_val_type':costs+values+['MWh','block_dist_comb'],'new_old':['new']}}),
            ('OLD System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9s', 'filter': {'cost_val_type':costs+values+['MWh','block_dist_comb'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),
            ...
            ('System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'sync_axes':'No', 'bar_width':r'.9s', 'filter': {'cost_val_type':['sys_lcoe_num','total value'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),
            ...
            ('Value factor Load Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load over time', {'chart_type':'Bar', 'x':'year', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'explode_group':'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'sync_axes':'No', 'bar_width':r'1.75', 'filter': {'new_old':['new'], 'cost_val_type':['block_dist_load','Energy Value','surplus'], }}),
            ...
            ('Curtail Frac over time', {'chart_type':'Line', 'x':'year', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'explode_group':'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'Energy Value', 'y_scale':'-1', 'sync_axes':'No', 'bar_width':r'1.75', 'filter': {'new_old':['new'], 'cost_val_type':['Energy Value','surplus'], }}),

            ('Value factor Res Marg Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_resmarg', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
            ...
            ('CC Res Marg by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_cap_local_resmarg', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_cap_local_resmarg','Capacity Value'],'new_old':['new']}}),
    ...
    ('Tech Val Streams potential',
        ...
        'presets': collections.OrderedDict((
            ('$/kW by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values,'new_old':['new']}}),
            ('$/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp,'new_old':['new']}}),
            ('$/kW by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values,'new_old':['new']}}),
            ('$/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp,'new_old':['new']}}),
            ('Load $/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load,'new_old':['new']}}),
            ('Load $/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_load,'new_old':['new']}}),
            ('Resmarg $/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_resmarg,'new_old':['new']}}),
            ('Resmarg $/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_resmarg,'new_old':['new']}}),

            ('$/MWh by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values+['MWh/kW'],'new_old':['new']}}),
            ('$/MWh by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['MWh/kW'],'new_old':['new']}}),
            ('$/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp+['MWh/kW'],'new_old':['new']}}),
            ('$/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp+['MWh/kW'],'new_old':['new']}}),
            ('LCOE final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),
            ('LCOE final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),
            ('Load $/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load+['MWh/kW'],'new_old':['new']}}),
            ('Load $/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_load+['MWh/kW'],'new_old':['new']}}),
            ('Resmarg $/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_resmarg+['MWh/kW'],'new_old':['new']}}),
            ('Resmarg $/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_resmarg+['MWh/kW'],'new_old':['new']}}),

            ('Stacked profitability final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values+['total cost'],'new_old':['new']}}),
            ('Stacked profitability final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['total cost'],'new_old':['new']}}),
            ('Stacked profitability final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp+['total cost'],'new_old':['new']}}),
            ('Stacked profitability final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp+['total cost'],'new_old':['new']}}),
            ('Load profit final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load+['total cost'],'new_old':['new']}}),
            ...
            ('OLD System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['MWh/kW','block_dist_comb'],'new_old':['new']}}),
            ('System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['total value','sys_lcoe_num'],'new_old':['new']}}),
            ...
            ('Value factor Combined Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_comb']+values,'new_old':['new']}}),
            ('Value factor Combined Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_comb']+values,'new_old':['new']}}),

            ('Value factor Load Dist by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ...
            ('Value factor Res Marg Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9s', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
        )),
        }
    ),
    ('Marginal Prices',
