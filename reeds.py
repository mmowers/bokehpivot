...
results_meta = collections.OrderedDict((
    ('Capacity (GW)',
        ...
        'presets': collections.OrderedDict((
            ...
            ('Stacked Columns 2020, 2030, 2050',{'x':'scenario','y':'Capacity (GW)', 'y_agg':'Sum','series':'tech', 'explode': 'year', 'chart_type':'Bar', 'filter': {'year': [2020, 2030, 2050]}}),
            ('State Map: 2030 Wind',{'x':'st','y':'Capacity (GW)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('State Map: 2030 PV',{'x':'st','y':'Capacity (GW)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)'], 'year': [2030]}}),
            ('State Map: 2050 Wind',{'x':'st','y':'Capacity (GW)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['Wind'], 'year': [2050]}}),
            ('State Map: 2050 PV',{'x':'st','y':'Capacity (GW)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)'], 'year': [2050]}}),
    ...
    ('Generation (TWh)',
        ...
        'presets': collections.OrderedDict((
            ...
            ('State Map: 2030 PV',{'x':'st','y':'Generation (TWh)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)'], 'year': [2030]}}),
            ('State Map: 2050 Wind',{'x':'st','y':'Generation (TWh)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['Wind'], 'year': [2050]}}),
            ('State Map: 2050 PV',{'x':'st','y':'Generation (TWh)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)'], 'year': [2050]}}),
            ('PCA Map: 2030 Wind',{'x':'n','y':'Generation (TWh)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('PCA Map: 2030 PV',{'x':'n','y':'Generation (TWh)', 'y_agg':'Sum', 'explode': 'scenario','chart_type':'Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)'], 'year': [2030]}}),
