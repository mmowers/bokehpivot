...
results_meta = collections.OrderedDict((
    ...
    ('Tech Val Streams chosen',
        ...
        'presets': collections.OrderedDict((
            ...
            ('LCOE final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'bar_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'y_scale':'-1', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+['MWh'], 'year':'last', }}),
            ...
            ('OLD System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'bar_sort': 'Descending', 'filter': {'cost_val_type':costs+values+['MWh','block_dist_comb'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),
            ...
            ('System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'sync_axes':'No', 'bar_width':r'.9', 'bar_sort': 'Descending', 'filter': {'cost_val_type':['sys_lcoe_num','total value'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),
            ...
            ('Value factor Load Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_load','Energy Value','surplus'],'new_old':['new']}}),
    ...
    ('Tech Val Streams potential',
        ...
        'presets': collections.OrderedDict((
            ...
            ('LCOE final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),
            ('LCOE final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),
            ...
            ('OLD System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['MWh/kW','block_dist_comb'],'new_old':['new']}}),
            ('System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['total value','sys_lcoe_num'],'new_old':['new']}}),
            ...
            ('Value factor Load Dist by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_load','Energy Value','surplus'],'new_old':['new']}}),
            ('Value factor Load Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'bar_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_load','Energy Value','surplus'],'new_old':['new']}}),
