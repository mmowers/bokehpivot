...
rb_globs = {'output_subdir': '/gdxfiles/', 'test_file': 'CONVqn.gdx', 'report_subdir':'/reeds'}
...
def pre_elec_price(df, **kw):
    ...
    df.drop(['t2','t4','t5','t6','t7','t8','t9','t10','t11','t12','t13','t14','t15','t16'], axis='columns', errors='ignore', inplace=True)
...
results_meta = collections.OrderedDict((
    ('Capacity (GW)',
        ...
        'presets': collections.OrderedDict((
            ...
            ('State Map 2030 Wind',{'x':'st','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('State Map 2030 Solar',{'x':'st','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': [2030]}}),
            ('State Map Final Wind',{'x':'st','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': 'last'}}),
            ('State Map Final Solar',{'x':'st','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': 'last'}}),
            ('PCA Map 2030 Wind',{'x':'n','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('PCA Map 2030 Solar',{'x':'n','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': [2030]}}),
            ('PCA Map Final Wind',{'x':'n','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': 'last'}}),
            ('PCA Map Final Solar',{'x':'n','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': 'last'}}),
        )),
        }
    ),
    ('New Capacity (GW)',
    ...
    ('Wind Capacity (GW)',
        ...
        'presets': collections.OrderedDict((
            ('Final Map',{'x':'i','y':'Capacity (GW)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'year': 'last'}}),
        )),
        }
    ),
    ('Generation (TWh)',
        ...
        'presets': collections.OrderedDict((
            ...
            ('State Map 2030 Wind',{'x':'st','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('State Map 2030 Solar',{'x':'st','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': [2030]}}),
            ('State Map Final Wind',{'x':'st','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': 'last'}}),
            ('State Map Final Solar',{'x':'st','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': 'last'}}),
            ('PCA Map 2030 Wind',{'x':'n','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': [2030]}}),
            ('PCA Map 2030 Solar',{'x':'n','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': [2030]}}),
            ('PCA Map Final Wind',{'x':'n','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['Wind'], 'year': 'last'}}),
            ('PCA Map Final Solar',{'x':'n','y':'Generation (TWh)', 'explode': 'scenario','chart_type':'Area Map', 'filter': {'tech': ['PV (AC)', 'Distributed PV (AC)', 'CSP'], 'year': 'last'}}),
        )),
        }
    ),
    ...
    ('Tech Val Streams chosen',
        ...
        'presets': collections.OrderedDict((
            ...
            ('$ by type final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values, 'year':'last', }}),
            ...
            ('$/kW by type final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'kW', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['kW'], 'year':'last', }}),
            ...
            ('$/MWh by type final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['MWh'], 'year':'last', }}),
            ...
            ('LCOE final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Ascending', 'plot_width':'600', 'plot_height':'600', 'y_scale':'-1', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+['MWh'], 'year':'last', }}),
            ...
            ('Profitability final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values+['total cost'], 'year':'last', }}),
    ...
    ('Tech Val Streams chosen detailed',
        {'sources': [
            {'name': 'valstream', 'file': 'valuestreams/valuestreams_chosen.csv'},
            {'name': 'load', 'file': 'valuestreams/load_pca_chosen.csv'},
            {'name': 'prices_nat', 'file': 'MarginalPrices.gdx', 'param': 'p_block_nat_ann', 'columns': ['type','year','$/MWh']},
        ...
        'preprocess': [
            {'func': pre_tech_val_streams, 'args': {'cat':'chosen','detailed':True,'decompose':False}},
        ],
        'presets': collections.OrderedDict((
            ...
            ('Resmarg $/kW decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'kW', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg_cap+['kW'], 'year':'last', }}),
            ...
            ('$/MWh by type decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values_decomp+['MWh'], 'year':'last', }}),
            ...
            ('Load $/MWh decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_load+['MWh'], 'year':'last', }}),
            ...
            ('Resmarg $/MWh decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg+['MWh'], 'year':'last', }}),
            ...
            ('Profitability decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':costs+values_decomp+['total cost'], 'year':'last', }}),
            ...
            ('Load profit decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_load+['total cost'], 'year':'last', }}),
            ...
            ('Resmarg profit decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg+['total cost'], 'year':'last', }}),
            ...
            ('Resmarg cap profit decomposed final', {'chart_type':'Bar', 'x':'tech', 'y':'$', 'series':'cost_val_type', 'explode':'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Descending', 'plot_width':'600', 'plot_height':'600', 'filter': {'new_old':['new'], 'tech':{'exclude':['Distributed PV (AC)','distpv']}, 'cost_val_type':values_resmarg_cap+['total cost'], 'year':'last', }}),
            ...
            ('System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Ascending', 'filter': {'cost_val_type':['sys_lcoe_num','total value'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),
            ...
            ('OLD System LCOE final', {'chart_type':'Bar', 'x':'tech','y':'$','series':'cost_val_type', 'explode': 'scenario', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh', 'y_scale':'-1', 'sync_axes':'No', 'bar_width':r'.9', 'cum_sort': 'Ascending', 'filter': {'cost_val_type':costs+values+['MWh','Base Price'],'new_old':['new'],'year':'last','exclude':['Distributed PV (AC)','distpv']}}),

            ('Value factor Combined Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_comb', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_comb']+values,'new_old':['new']}}),
            ('Value factor Combined Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_comb', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_comb']+values,'new_old':['new']}}),
            ...
            ('Value factor Load Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','Curtailment'],'new_old':['new']}}),
            ('Value factor Load Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_load','Energy Value','Curtailment'],'new_old':['new']}}),
            ...
            ('Value factor Res Marg Dist by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_resmarg', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final', {'x':'n','y':'$','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'600', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
    ...
    ('Tech Val Streams potential raw',
        ...
        'presets': collections.OrderedDict((
            ('$/kW by type final', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','type':{'exclude':['profit','reduced_cost']},'new_old':['new']}}),
            ('$/kW by type final p60', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','type':{'exclude':['profit','reduced_cost']},'new_old':['new']}}),
            ('$/kW by type retire final', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','type':{'exclude':['profit','reduced_cost']},'new_old':['retire']}}),
            ('$/kW by type retire final p60', {'x':'var_set','y':'$/kW','series':'type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','type':{'exclude':['profit','reduced_cost']},'new_old':['retire']}}),
        )),
        }
    ),
    ('Tech Val Streams potential',
        ...
        'presets': collections.OrderedDict((
            ...
            ('$/kW by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values,'new_old':['new']}}),

            ('$/MWh by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values+['MWh/kW'],'new_old':['new']}}),
            ('$/MWh by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['MWh/kW'],'new_old':['new']}}),
            ('LCOE final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Ascending', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),
            ('LCOE final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Ascending', 'sync_axes':'No', 'y_scale':'-1', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+['MWh/kW'],'new_old':['new']}}),

            ('Stacked profitability final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values+['total cost'],'new_old':['new']}}),
            ('Stacked profitability final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['total cost'],'new_old':['new']}}),

        )),
        }
    ),
    ('Tech Val Streams potential detailed',
        {'sources': [
            {'name': 'valstream', 'file': 'valuestreams/valuestreams_potential.csv'},
            {'name': 'load', 'file': 'valuestreams/load_pca_potential.csv'},
            {'name': 'levels_potential', 'file': 'valuestreams/levels_potential.csv'},
        ...
        'preprocess': [
            {'func': pre_tech_val_streams, 'args': {'cat':'potential','detailed':True,'decompose':False}},
        ],
        'presets': collections.OrderedDict((
            ('$/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp,'new_old':['new']}}),
            ('$/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp,'new_old':['new']}}),
            ('Load $/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load,'new_old':['new']}}),
            ('Load $/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_load,'new_old':['new']}}),
            ('Resmarg $/kW by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_resmarg,'new_old':['new']}}),
            ('Resmarg $/kW by type final p60 decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_resmarg,'new_old':['new']}}),

            ('$/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp+['MWh/kW'],'new_old':['new']}}),
            ('$/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp+['MWh/kW'],'new_old':['new']}}),
            ('Load $/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load+['MWh/kW'],'new_old':['new']}}),
            ('Load $/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_load+['MWh/kW'],'new_old':['new']}}),
            ('Resmarg $/MWh by type final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_resmarg+['MWh/kW'],'new_old':['new']}}),
            ('Resmarg $/MWh by type final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_resmarg+['MWh/kW'],'new_old':['new']}}),

            ('Stacked profitability final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':costs+values_decomp+['total cost'],'new_old':['new']}}),
            ('Stacked profitability final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values_decomp+['total cost'],'new_old':['new']}}),
            ('Load profit final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_load+['total cost'],'new_old':['new']}}),
            ('Load profit final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_load+['total cost'],'new_old':['new']}}),
            ('Resmarg profit final decomposed', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':values_resmarg+['total cost'],'new_old':['new']}}),
            ('Resmarg profit final decomposed p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'chart_type':'Bar', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total cost', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':values_resmarg+['total cost'],'new_old':['new']}}),

            ('System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'total value', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Ascending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['total value','sys_lcoe_num'],'new_old':['new']}}),
            ('OLD System LCOE final p60', {'chart_type':'Bar', 'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'MWh/kW', 'y_scale':'-1', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Ascending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':costs+values+['MWh/kW','Base Price'],'new_old':['new']}}),

            ('Value factor Combined Dist by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_comb']+values,'new_old':['new']}}),
            ('Value factor Combined Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_comb']+values,'new_old':['new']}}),
            ('Value factor Combined Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_comb']+values,'new_old':['new']}}),
            ('Value factor Combined Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_comb', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_comb']+values,'new_old':['new']}}),

            ('Value factor Load Dist by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_load','Energy Value','Curtailment'],'new_old':['new']}}),
            ('Value factor Load Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_load','Energy Value','Curtailment'],'new_old':['new']}}),
            ('Value factor Load Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_load','Energy Value','Curtailment'],'new_old':['new']}}),
            ('Value factor Load Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_load', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_load','Energy Value','Curtailment'],'new_old':['new']}}),

            ('Value factor Res Marg Dist by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_dist_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Dist by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_dist_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_dist_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
            ('Value factor Res Marg Local by type final p60', {'x':'var_set','y':'$/kW','series':'cost_val_type', 'explode': 'scenario', 'explode_group': 'tech', 'adv_op':'Ratio', 'adv_col':'cost_val_type', 'adv_col_base':'block_local_resmarg', 'chart_type':'Bar', 'plot_width':'1200', 'bar_width':'0.9', 'cum_sort': 'Descending', 'sync_axes':'No', 'filter': {'n':['p60'],'year':'last','cost_val_type':['block_local_resmarg','Capacity Value'],'new_old':['new']}}),
        )),
        }
    ),
    ('Marginal Prices',
    ...
    ('JEDI Outputs',
        ...
        'presets': collections.OrderedDict((
            ...
            ('Average Onsite Jobs Map 2017-end',{'chart_type':'Area Map', 'x':'st', 'y':'value', 'explode':'scenario', 'explode_group':'jedi_scenario', 'y_scale':'29412', 'filter': {'metric':['jobs'], 'directness':['Onsite'], 'year': {'start':2017},}}), #y_scale, 29412 = 1000000(jobs per mil jobs) / 34(total years), so we end up with avarage jobs
        )),
        }
    ),
    ('JEDI Outputs csv',
