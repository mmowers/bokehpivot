static_presets = [
    ...
    {'name': 'Operating Reserves (GW-h)', 'result': 'Operating Reserves (GW-h)', 'preset': 'Stacked Bars'},
    ...
    {'name': 'National Energy Price by timeslice ($/MWh)', 'result': 'Energy Price by Timeslice National ($/MWh)', 'preset': 'Stacked Bars Final'},
    {'name': 'National OpRes Price ($/MW-h)', 'result': 'OpRes Price National ($/MW-h)', 'preset': 'Scenario Lines Over Time'},
    {'name': 'National OpRes Price by timeslice ($/MW-h)', 'result': 'OpRes Price by Timeslice National ($/MW-h)', 'preset': 'Stacked Bars Final'},
    {'name': 'Final Regional Energy Price (2015$/MWh)', 'result': 'Energy Price BA ($/MWh)', 'preset': 'Final BA Map'},
    {'name': 'National Seasonal Capacity Price ($/kW-yr)', 'result': 'Seasonal Capacity Price National ($/kW-yr)', 'preset': 'Scenario Lines Over Time'},
    {'name': 'National Annual Capacity Price ($/kW-yr)', 'result': 'Annual Capacity Price National ($/kW-yr)', 'preset': 'Scenario Lines Over Time'},
