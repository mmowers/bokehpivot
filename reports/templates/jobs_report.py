...
static_presets = [
    ...
    {'name': 'Wind Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'config': {'filter': {'jedi_tech':['wind']}}},
    {'name': 'Wind Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['wind']}}},
    {'name': 'UPV Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'config': {'filter': {'jedi_tech':['upv']}}},
    {'name': 'UPV Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['upv']}}},
    {'name': 'Coal Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'config': {'filter': {'jedi_tech':['coal']}}},
    {'name': 'Coal Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['coal']}}},
    {'name': 'Gas Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'config': {'filter': {'jedi_tech':['gas']}}},
    {'name': 'Gas Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Directness', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['gas']}}},
    ...
    {'name': 'Average Direct Jobs 2017-2050 (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050'},
    {'name': 'Average Direct Jobs 2017-2050 Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050', 'modify': 'diff'},
    {'name': 'Average Direct Renewable Jobs 2017-2050 (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050', 'config':{'filter':{'jedi_tech':['wind','upv']}}},
    {'name': 'Average Direct Renewable Jobs 2017-2050 Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050', 'modify': 'diff', 'config':{'filter':{'jedi_tech':['wind','upv']}}},
    {'name': 'Average Direct Fossil Jobs 2017-2050 (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050', 'config':{'filter':{'jedi_tech':['coal','gas']}}},
    {'name': 'Average Direct Fossil Jobs 2017-2050 Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Average Direct Jobs Map 2017-2050', 'modify': 'diff', 'config':{'filter':{'jedi_tech':['coal','gas']}}},
]
