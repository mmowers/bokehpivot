...
static_presets = [
    ...
    {'name': 'Wind Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'config': {'filter': {'jedi_tech':['wind'], 'metric':['jobs']}}},
    {'name': 'Wind Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['wind'], 'metric':['jobs']}}},
    {'name': 'UPV Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'config': {'filter': {'jedi_tech':['upv'], 'metric':['jobs']}}},
    {'name': 'UPV Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['upv'], 'metric':['jobs']}}},
    {'name': 'Coal Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'config': {'filter': {'jedi_tech':['coal'], 'metric':['jobs']}}},
    {'name': 'Coal Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['coal'], 'metric':['jobs']}}},
    {'name': 'Gas Jobs (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'config': {'filter': {'jedi_tech':['gas'], 'metric':['jobs']}}},
    {'name': 'Gas Jobs Diff (millions)', 'result': 'JEDI Outputs', 'preset': 'Stacked Jobs By Category', 'modify': 'diff', 'config': {'filter': {'jedi_tech':['gas'], 'metric':['jobs']}}},
