static_presets = [
    ...
    {'name': 'Average Onsite Jobs 2017-End', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end'},
    {'name': 'Average Onsite Jobs 2017-End Diff', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end', 'modify': 'diff'},
    {'name': 'Average Onsite Renewable Jobs 2017-End', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end', 'config':{'filter':{'jedi_tech':['wind','upv']}}},
    {'name': 'Average Onsite Renewable Jobs 2017-End Diff', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end', 'modify': 'diff', 'config':{'filter':{'jedi_tech':['wind','upv']}}},
    {'name': 'Average Onsite Fossil Jobs 2017-End', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end', 'config':{'filter':{'jedi_tech':['coal','gas']}}},
    {'name': 'Average Onsite Fossil Jobs 2017-End Diff', 'result': 'JEDI Outputs', 'preset': 'Average Onsite Jobs Map 2017-end', 'modify': 'diff', 'config':{'filter':{'jedi_tech':['coal','gas']}}},
]
