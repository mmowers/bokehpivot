...
static_presets = [
    ...
    {'name': 'US cumulative by state past two weeks', 'config':{'chart_type':'Bar', 'x':'days ago', 'y':'number', 'series':'us top st', 'explode':'type', 'plot_width':'400', 'y_min':'0', 'x_title':'Days ago', 'sync_axes':'No', 'filter':{'country':['US'], 'days ago':list(range(15))}}},
