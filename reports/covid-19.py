...
static_presets = [
    ...
    {'name': 'US cumulative infections by state past two days', 'config':{'chart_type':'Area Map', 'x':'st', 'y':'number', 'explode':'days ago', 'filter':{'days ago':[0,1,2,3], 'country':['US'], 'st':states, 'type':['Confirmed']}}},
    {'name': 'US cumulative deaths by state past two days', 'config':{'chart_type':'Area Map', 'x':'st', 'y':'number', 'explode':'days ago', 'filter':{'days ago':[0,1,2,3], 'country':['US'], 'st':states, 'type':['Deaths']}}},
]
